...
public class Player extends Entity {
    ...
    public void update(){
        ...
        if (objIndex == 15 && knowbed == 1 ){
            ...
            knowbed2 = 1;
            gp.playSE(1);
            gp.obj[27] = new OBJ_keycard();
            gp.obj[27].x = 3*gp.tileSize;
            gp.obj[27].y = 14*gp.tileSize;
        }else if(objIndex == 15){
            gp.TriggerText();
        }
        if (objIndex == 27 ){//keycard
            gp.playSE(1);
            keycard = 1;
            pickUpObject(objIndex);
        }
        ...
        if (objIndex == 9 && red == 6 && green==5 && blue==4 && black==7 && knowbed2==1 && coderkey==1 && keycard == 1 ){ //Exit
            gp.triggerWinner();
            gp.playSE(4);
        }else if (objIndex == 9){
            gp.playSE(5);
