    ...
    public class GamePanel extends JPanel implements Runnable {
        ...
        private BufferedImage interactionImage0, interactionImage1;
    ...
    private void displayGame(Graphics2D g2) {
        ...
        g2.setColor(Color.WHITE);
        g2.setFont(ui.maruMonica);
        g2.setFont(g2.getFont().deriveFont(Font.TYPE1_FONT,20));
        g2.drawString("Time left: " + countdown, 10, 20);
        
        g2.setFont(new Font("Arial", Font.PLAIN, 15));
        g2.drawString(""+player.red, 403, 224);
        g2.drawString(""+player.green, 499, 224);
        g2.drawString(""+player.blue, 595, 224);
        g2.drawString(""+player.black, 691, 224);
